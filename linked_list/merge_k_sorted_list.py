...
1. two classes: Node and LinkedList
one function: merges linked list 
2. Merge linked list by, 
 first, inserting the list to first list
 then, sort the list
...
# lls = Node(1)
# lls.next = Node(3)
# lls.next.next = Node(5)
# lls.next.next.next = Node(7)
